...
const initDb = () => {
    return sequelize.sync({ force: true }).then(_ => {//force seulement pour le developpement pour facilité les corrections sur les modèle
        ...
        bcrypt.hash('pikachu', 10) //valeur du mot de passe et un entier pour temps de hasher le mot de passe
            .then(hash => {
                User.create({
                    userName: 'pikachu',
                    password: hash
